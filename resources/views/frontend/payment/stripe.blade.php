...
@section('frontend-content')
                                        ...
                                        <ul class="nav nav-checkout-progress list-unstyled">
                                            ...
                                            <li>
                                                @if (session()->has('coupon'))
                                                    <strong>Subtotal: </strong> {{ $data['cartTotal'] }} <br>
                                                ...
                                                @else
                                                    <strong>Subtotal: </strong> {{ $data['cartTotal'] }}<br>
                                                    <strong>GrandTotal: </strong> {{ $data['cartTotal'] }}
                                                @endif
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe('pk_test_51K4GINDfqbtwx5tX7KGbOO8xemeqt0n1Z82H7aB3wrxENcwis0RAtvvfcpIqUKgIGqO1tkFe4crrERAKwuHVIYdQ00ozdmDNuT');
