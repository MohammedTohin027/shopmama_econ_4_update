...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        # CUSTOMER INFORMATION
          ...
          $post_data['payment_method'] = "SSL Host Payment";
          $post_data['payment_type'] = "SSL Host Payment";
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $post_data['user_id'] = Auth::id();
        $post_data['payment_type'] = "SSL Easy Payment";
        $post_data['payment_method'] = "SSL Easy Payment";
        $post_data['invoice_no'] = 'SPM'.mt_rand(10000000,99999999);
        $post_data['order_number'] = mt_rand(10000000,99999999);
