...
Route::get('product/view/model/{id}', [FrontendController::class, 'productViewAjax']);
Route::post('/cart/data/store/{id}', [CartController::class, 'addToCart']);
Route::get('/minicart/product/view', [CartController::class, 'miniCartProductView']);
Route::get('/minicart/product/remove/{id}', [CartController::class, 'miniCartRemove']);

Route::get('/cartpage/view', [CartController::class, 'cartPageView'])->name('cart.page.view');
Route::get('/get/cart/product', [CartController::class, 'getCartProduct']);
Route::get('/cart-increment/{id}', [CartController::class, 'CartProductIncrementById']);
...
Route::get('/user/district/ajax/{id}', [AjaxController::class, 'getDistrict']);
Route::get('/user/state/ajax/{id}', [AjaxController::class, 'getState']);
...
Route::group(['prefix' => 'user', 'middleware' =>['user', 'auth'] ], function(){
    ...
    Route::prefix('user')->group(function () {
        Route::get('order/view', [UserController::class, 'orderView'])->name('user.order.view');
    });

    //  checkout
    Route::get('/checkout-view', [CheckoutController::class, 'index'])->name('checkout.view');
    Route::post('/checkout', [CheckoutController::class, 'checkoutStore'])->name('user.checkout.store');

    //  stripe
    Route::post('stripe/payment', [StripeController::class, 'storeCheckout'])->name('stripe.order');
...
Route::group(['prefix' => 'admin', 'middleware' =>['admin', 'auth', 'permission'] ], function(){
    ...
    Route::get('/state/ajax/{id}', [AjaxController::class, 'getState']);
